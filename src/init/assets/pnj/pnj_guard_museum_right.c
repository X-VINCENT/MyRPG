...
void init_text_pnj_gright(pnj_t *pnj, sfVector2f pos)
{
    int nbr_text = my_arrlen(message_g_right);
...
void init_pnj_guard_right(game_t *game)
{
    ...
    pnj_t *pnj = assets->pnj[PNJ_GUARD_RIGHT];
    sfTexture *texture = game->textures->blue_girl_pnj;
    sfVector2f position = {2440, 1760};
